...
export default function DownloadPage() {
  ...
  const downloadUrls: Record<string, string> = {
    windows: 'https://www.getreadin.us/downloads/ReadInAI-Windows-1.4.0.zip',
    mac: 'https://www.getreadin.us/downloads/ReadInAI-macOS-1.4.0.dmg',
    linux: 'https://www.getreadin.us/downloads/ReadInAI-Linux-1.4.0.AppImage',
  }
