...
export default function DownloadPage() {
  ...
  const downloadUrls: Record<string, string> = {
    windows: 'https://github.com/derickjoseph8/readin-ai/releases/download/v1.4.0/ReadInAI-Windows-1.4.0.zip',
    mac: 'https://github.com/derickjoseph8/readin-ai/releases/download/v1.4.0/ReadInAI-macOS-1.4.0.dmg',
    linux: 'https://github.com/derickjoseph8/readin-ai/releases/download/v1.4.0/ReadInAI-Linux-1.4.0.AppImage',
  }
